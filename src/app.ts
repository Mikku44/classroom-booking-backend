...
app.get('/health', (_req, res) => res.json({ success: true, message: 'Healthy', data: { service: 'classroom-reservation-api' } }));
app.use(helmet());
app.use(cors());
app.use(express.json());
app.use('/assets', express.static('public/assets', { maxAge: '1d', immutable: false }));
